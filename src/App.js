...
function App() {
    ...
    useEffect(() => {
        async function Fetch() {
            try{
                let response = await fetch('https://realestate2024-dnem88s-projects.vercel.app/deals', {
                    headers: {
                        'content-type': 'application/json',
                        'Authorization': user ? user.user.authToken : 'Unauthorized'
                    }
     ...
     useEffect(() => {
       async function FetchCalls() {
        try {
          const response = await fetch('https://realestate2024-dnem88s-projects.vercel.app/calls', {
            headers: {
              'Content-type': 'application/json',
              'Authorization': user ? user.user.authToken : 'Unauthorized'
            }
    ...
    useEffect(() => {
      //  'https://realestate2024-dnem88s-projects.vercel.app/tasks'
